...
const QuitNav = () => {
  ...
  return (
    ...
    > 
    <div
      className={`w-1/3 h-full text-xl flex justify-center items-center border-r border-t-2 border-slate-600 
    ...
    <div
      className={`w-1/3 h-full text-xl flex justify-center items-center border-t-2 border-slate-600
