  ...
  return (
    ...
    >
      ...
      <div className="w-full p-5 text-justify flex flex-col gap-5">
        ...
        <section>
          <h1 className="text-4xl mb-2.5 text-center font-bold sm:text-left text-blue-600 dark:text-blue-400">Introduction</h1>
          <p className="text-lg">
        ...
        <section>
          <h1 className="text-4xl mb-2.5 text-center font-bold sm:text-left text-blue-600 dark:text-blue-400">About Addiction</h1>
          <p className="text-lg">
        ...
        <section>
          <h1 className="text-4xl mb-2.5 text-center font-bold sm:text-left text-blue-600 dark:text-blue-400">About the Website</h1>
          <p className="text-lg">
